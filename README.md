...
বর্তমানে কুবারনেটেস নেটওয়ার্কিং লেয়ারে Ingress-এর সীমাবদ্ধতা দূর করতে **Gateway API** ব্যবহৃত হচ্ছে। এই প্রোজেক্টের মাধ্যমে আমি নিচের বিষয়গুলো ইমপ্লিমেন্ট করেছি:
...
Bash
# Envoy Gateway এবং প্রয়োজনীয় CRDs ইনস্টল
